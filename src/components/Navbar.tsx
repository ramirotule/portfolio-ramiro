      ...
      >
        ...
        <div className="flex items-center gap-8">
          <div className="hidden md:flex gap-6 text-sm font-display uppercase tracking-widest text-[#adaaab]">
            ...
            <Link
              to="/projects"
              className={`${isActive("/projects") ? "text-primary" : "hover:text-primary"} transition-colors`}
            >
              {t("nav.projects")}
            </Link>
            <Link
              to="/experience"
              className={`${isActive("/experience") ? "text-primary" : "hover:text-primary"} transition-colors`}
            >
              {t("nav.experience")}
            </Link>
            <Link
              to="/interests"
              className={`${isActive("/interests") ? "text-primary" : "hover:text-primary"} transition-colors`}
            >
              {t("nav.interests")}
            </Link>
            <Link
              to="/contact"
              className={`${isActive("/contact") ? "text-primary" : "hover:text-primary"} transition-colors`}
            >
              {t("nav.contact")}
            </Link>
          </div>
